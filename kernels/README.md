...
| `aie2/` | In-flight 4-D DMA receptive field generation and vectorized zero-realignment 3×3 conv kernel | Replaces software `sliding_mul` shuffles (`vshift`/`vmov`) with MemTile 4-D DMA striding. **2.00× MAC issue density uplift** (0.222 → 0.444 vmac/cycle) with 0 realignment ops and 0 spills. Compiler-verified; [implementation](../results/aie/notes_im2col_4d_implementation.md) and [VLIW audit](../results/aie/notes_im2col_kernel_vliw_audit.md) |
