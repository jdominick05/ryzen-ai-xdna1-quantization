...
#
#   ./scripts/quant-adaround.sh --quant models/resnet50_ignition_cle_c64.onnx --out models/resnet50_ignition_cle_adaround_c64.onnx --log results/quant/quant_resnet50_ignition_cle_adaround_c64.log [--in-model models/resnet50_fp32.onnx] [--calib-dir data/calib] [--iters 1000] [--data-size 1000] [--seed 1705472343]
...
QUANT="" OUT="" LOG="" IN=models/resnet50_fp32.onnx CALIB_DIR="" ITERS=1000 DATA=1000 SEED=1705472343
while [ $# -gt 0 ]; do
    case "$1" in
        --quant) QUANT="$2"; shift ;;
        --out) OUT="$2"; shift ;;
