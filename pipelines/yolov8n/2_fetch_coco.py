"""
YOLO step 2: download COCO val2017 (5k images, ~780MB) + annotations (~240MB).
Ungated, no login. Makes a calibration subset.

    python pipelines/yolov8n/2_fetch_coco.py --n-calib 300

Produces:
    data/coco/val2017/*.jpg                       (all 5000, for mAP eval)
    data/coco/annotations/instances_val2017.json
    data/coco_calib/*.jpg                         (every Nth image)
"""
import argparse
import os
import shutil
