...
Local incident follow-up (2026-09-08): [overnight Windows crash investigation and evidence](scratch/quant-worktree/crash-handoff-2026-09-08.md).

This primary-workspace copy points into the isolated Ignition worktree. The tracked version is [scratch/quant-worktree/claude-handoff.md](scratch/quant-worktree/claude-handoff.md) on `ignition-alpha`.
...
[quant/README.md](scratch/quant-worktree/quant/README.md) is the supported-scope quickstart;
[quant/TODO.md](scratch/quant-worktree/quant/TODO.md) is the prioritized implementation backlog.
...
[Alpha validation](scratch/quant-worktree/docs/BENCHMARKS.md#ignition-alpha-release-validation).
...
[BENCHMARKS](scratch/quant-worktree/docs/BENCHMARKS.md#ignition-controlled-resnet-qdq-acceptance), engineering
rules in [DECISIONS](scratch/quant-worktree/docs/DECISIONS.md#locked-decisions-do-not-reopen), and implementation
scope in [quant/DESIGN.md](scratch/quant-worktree/quant/DESIGN.md). The old local `HANDOFF_CODEX.md` describes
...
- The [source/model audit](scratch/quant-worktree/results/quant/notes_xint8_dialect.log) corrected the draft
...
- Independent calibration and float-weight re-emission match a fresh no-CLE Quark
  ...
  [graph diff](scratch/quant-worktree/results/quant/diff_resnet50_own_nocle_c64.log) and the
  [producer method/full-set evidence](scratch/quant-worktree/docs/BENCHMARKS.md#owned-resnet50-no-cle-re-emission-and-independent-calibration).
...
[corrected summary](scratch/quant-worktree/results/quant/probe_resnet50_acceptance_summary_v2.log) and
[archived EP diagnostic](scratch/quant-worktree/results/quant/diag_ignition_acceptance_archived.log) bind the
...
headline models. See the [baseline](scratch/quant-worktree/results/quant/probe_resnet50_accept_full1000_baseline.log)
and [signed run](scratch/quant-worktree/results/quant/probe_resnet50_accept_full1000_act_int8_zp0.log).
...
[unoptimized audit v2](scratch/quant-worktree/results/quant/probe_resnet50_accept_c64_cpu_reference_audit_v2.log).
...
The [stop witness](scratch/quant-worktree/results/quant/probe_resnet50_accept_c64_weights_per_channel_resource_stop.log)
...
unchanged baseline hash were checked. Logs are indexed in [results/README.md](scratch/quant-worktree/results/README.md).
